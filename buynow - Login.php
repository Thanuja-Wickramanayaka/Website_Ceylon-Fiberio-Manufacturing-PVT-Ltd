...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/buynow-Login.css"> 
...
<section class="sub_header">
    <nav>
        <a href="index.php"><img src="images/logo/logo-tr.png" alt="image"></a>
    ...
    <div class="col-md-12">
        <div class="search">
            <input type="text" class="input" placeholder="What are you looking for ?">
                <div class="searchbtn">
                <a href="buynow-Login.php" class="search_btn"> <i class="fa fa-search"></i></a>
            </div>
        </div>
    </div>
</div>
    ...
    <section class="shop-cov">
      ...
      <div class="container">
            ...
            <div class="bottom-left">
                <h6 style="font-size: 17px;">       Please subscribe us to get latest news of our products.     </h6>
            ...
            <div class="top-left">      Already Have an account?
                <p>                     Let's get started..         <br>
                <a href="login.php"> <button type="acc-ok" class="account-btn">         Get Login       </button></a>
                </p>
            </div>

            <div class="top-right">     Still don't you have an account?
                <p>                     Don't worry let's create one.  <br>
                <a href="register.php"> <button type="acc-nok" class="account-btn">     Create Account  </button></a>
                </p>
            </div>
            
            <div class="bottom-right" style="font-size: 18px;"> 
