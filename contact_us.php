...
<section class="sub_header">
    <nav>
        <a href="contact_us.php"><img src="images/logo/logo-tr.png" alt="image"></a>
    ...
    <div class="col-md-12">
        <div class="search">
            <input type="text" class="input" placeholder="What are you looking for ?">
                <div class="searchbtn">
                <a href="contact_us.php" class="search_btn"> <i class="fa fa-search"></i></a>
            </div>
        </div>
    </div>
</div>
...
<section class="bac"> 
    <section class="location">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3719.161980583181!2d80.272583!3d7.452317600000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae325fe7ecf7e39%3A0x1e5d5fa9cd891252!2sCeylon%20Fiberio%20Manufacturing%20PVT%20Ltd.!5e1!3m2!1sen!2slk!4v1664096056618!5m2!1sen!2slk" 
    ...
    <div class="row">
        <div class="contact-col">
            <div>
                ...
                <span>
                    <h4>    Ceylon Fiberio Manufacturing PVT Ltd.   </h4>
                    <p>     No 567/2        <br> 
                            Negambo Road    <br>
                            Dehikumbura     <br>
                            Kurunegala      <br>
            ...
            <div>
                ...
                <span>
                    <h4>    Email   </h4>
                    <p>     <a href=" https://mail.google.com/mail/u/1/#inbox">
                            ceylonfiberio@gmail.com     </a>     <br>
                            Email us your queries. We are happy to help you.
                    </p>
                </span>
            </div>
            ...
            <div>
                ...
                <span>
                    ...
                    <p class="con-icons">  
                        ...
                        <a href="https://www.instagram.com/">   <i class="fa fa-instagram">         </i>     Instagram   </a>   <br>
                        <a href="https://twitter.com/?lang=en"> <i class="fa fa-twitter">           </i>     Twitter     </a>   <br>
                        <a href="https://lk.linkedin.com/">     <i class="fa fa-linkedin">          </i>     Linkedin    </a>
                    </p>
                </span>
            </div>
        ...
        <div class="contact-col" style="border: 1px solid lightgreen;  margin-bottom: 380px; ">

            <h2 class="msgh2">      Have Some Questions?    </h2> <br>
            <h3 class="msgh3">      Send Us A Message       </h3>
            <p class="msgp"><i>     We would love to hear from you & we are always ready to serve you...    </i>
            </p>
            ...
            <form action="action.php" method="POST" autocomplete="off">
                ...
                <button  type="submit" class="msg-submit-btn">  Send Message    </button>
            </form>

            
        </div>
    </div>
            <img class="palm" src="images/palmTree.png" alt="tree">
